				...
				<Grid container spacing={{ xs: 1, sm: 2, md: 2 }}>
					...
					<Grid item xs={12} md={6} lg={4}>
						...
						<Typography variant="body2">
							{datosUsuario.tipoIdentificacion || 'N/A'}
						</Typography>
					</Grid>
					<Grid item xs={12} md={6} lg={4}>
						<Typography variant="subtitle2" color="primary">
						...
						<Typography variant="body2">
							{datosUsuario.numeroIdentificacion || 'N/A'}
						</Typography>
					</Grid>
					...
					<Grid item xs={12} md={6} lg={4}>
						...
						<Typography variant="body2">
							{`${datosUsuario.nombres || 'N/A'} ${
								datosUsuario.apellidoPaterno || ''
							} ${datosUsuario.apellidoMaterno || ''}`.trim()}
						</Typography>
					</Grid>
					<Grid item xs={12} md={6} lg={4}>
						<Typography variant="subtitle2" color="primary">
						...
						<Typography variant="body2">
							{datosUsuario.fechaNacimiento || 'N/A'}
						</Typography>
					</Grid>
					<Grid item xs={12} md={6} lg={4}>
						<Typography variant="subtitle2" color="primary">
					...
					<Grid item xs={12} md={6} lg={4}>
						...
						<Typography variant="body2">
							{datosUsuario.regionResidencia || 'N/A'}
						</Typography>
					</Grid>
					<Grid item xs={12} md={6} lg={4}>
						<Typography variant="subtitle2" color="primary">
						...
						<Typography variant="body2">
							{datosUsuario.comunaResidencia || 'N/A'}
						</Typography>
					</Grid>
