      ...
      <section>
        {step === 0 && (
          <Box sx={{ display: 'flex', gap: 2, mb: 4 }}>
            <Button variant="contained" color="primary" onClick={() => setConfirmOpen(true)} sx={buttonStyles}>
          ...
          <>
			...
			<Grid container spacing={{ xs: 1, sm: 2, md: 2 }} p={1}>
				...
				<Grid item xs={12} md={6} lg={4}>
					...
					<Typography variant="body2">{datosMmrRespuesta.profesional}</Typography>
				</Grid>
				<Grid item xs={12}>
					<Typography variant="subtitle2" color="primary">
        ...
        <ConfirmDialog
          ...
          onConfirm={() => { console.log('MMR solicitada'); setStep(1); setConfirmOpen(false); }}
		onCancel={() => { setStep(2); setConfirmOpen(false); }}
