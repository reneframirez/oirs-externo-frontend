    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 p-8">
        ...
        <p className="text-sm text-gray-600 mb-6">
          Para que la Defensoría trámite sus solicitudes, es obligatorio que llene los espacios con asteriscos *
        </p>

        <h2 className="text-xl font-semibold text-blue-700 mb-4">Antecedentes del requerimiento</h2>

        <form className="space-y-6">
          <div className="grid grid-cols-2 gap-6">
            <FormControl fullWidth>
              <InputLabel>Región a la cual dirige su solicitud *</InputLabel>
              <Select label="Región a la cual dirige su solicitud *" startAdornment={<LocationOn className="mr-2" />}>
            ...
            <FormControl fullWidth>
              ...
              <Select label="Comuna a la cual dirige su solicitud *" startAdornment={<Home className="mr-2" />}>
                <MenuItem value="">Seleccione</MenuItem>
              </Select>
            </FormControl>
            ...
            <FormControl fullWidth>
              ...
              <Select label="Tipo solicitud *" startAdornment={<Assignment className="mr-2" />}>
                <MenuItem value="">Seleccione</MenuItem>
              </Select>
            </FormControl>
            ...
            <FormControl fullWidth>
              ...
              <Select label="¿Cómo desea recibir la respuesta? *" startAdornment={<Email className="mr-2" />}>
                <MenuItem value="">Seleccione</MenuItem>
              </Select>
            </FormControl>
          </div>
